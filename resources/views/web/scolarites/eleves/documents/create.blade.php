...
@section('content')
    ...
    <form action="{{ route('web.scolarites.eleves.documents.store', $eleve->id) }}" method="POST"
            ...
            <div class="col-sm-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" id="nom" name="nom" placeholder="Nom du Document" class="form-control"
                           value="{{ Session::get('_old_input')['nom'] ?? '' }}">
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" id="description" name="description" placeholder="Description du Document"
                           class="form-control" value="{{ Session::get('_old_input')['description'] ?? '' }}">
                </div>
            </div>
