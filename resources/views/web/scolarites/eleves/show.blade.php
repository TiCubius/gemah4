			...
			@slot("custom")
				<div class="btn-group">
					...
					<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
						...
						@endHas @hasPermission("affectations/materiels/index")
					...
					<div class="card-footer">
						<div class="dropup">
							...
							<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
								...
								@endHas @hasPermission("responsables/edit")
				...
				<div class="card w-100">
					<div class="card-header gemah-bg-primary d-flex align-items-center justify-content-between">
						...
						@if($responsable->pivot->etat_signature)
							<div class="badge badge-success m-0">Convention signée le {{ Carbon\Carbon::parse($responsable->pivot->date_signature)->format("d/m/Y") }}</div>
						@else
							<div class="badge badge-danger m-0">Convention non signée</div>
						@endif
					</div>
					<div class="card-body">
					...
					<div class="card-footer">
						<div class="dropup">
							...
							<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
								@hasPermission("responsables/show")
								<a class="dropdown-item" href="{{ route("web.responsables.show", [$responsable]) }}" target="_blank">Détails du responsable</a>
								@endHas
								@hasPermission("responsables/edit")
								<a class="dropdown-item" href="{{ route("web.responsables.edit", [$responsable]) }}" target="_blank">Éditer le responsable</a>
								@endHas
