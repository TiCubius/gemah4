                ...
                <form class="card" method="GET">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="date_naissance" class="form-control" name="date_naissance" type="text"
                        ...
                        <div class="form-group">
                            ...
                            <input id="code_ine" class="form-control" name="code_ine" type="text" placeholder="Code INE"
