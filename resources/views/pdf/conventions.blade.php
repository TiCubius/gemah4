    ...
    @foreach($eleve->responsables as $responsable)
        ...
        <header>
            ...
            <section id="informations"
                     style="display: inline-block; width: 125px; font-size: 10px; text-align: right; margin-top: -80px;">
                <p>
                    CONVENTIONS <br>
        ...
        <section id="content" style="font-size: 13px;">
            <section id="lois" style="text-align: justify;">
                <p>
                    <i>
                        ...
                        2001, sur lefinancement de matériels pédagogiques adaptés au bénéfice d’élèves présentant des
                        déficiencessensorielles ou motrices. Vu la circulaire n° 2001-221 du 29 octobre 2001 apportant
                        des précisionssur les conventions de mise à disposition de ces matériels.
                    </i>
                </p>
            </section>
            ...
            <section id="article3" style="text-align: justify;">
                ...
                <p>Il ne sera demandé aucune contribution financière au bénéficiaire à l'exclusion des consommables
                    indispensablesau fonctionnement du matériel.</p>
            </section>
            ...
            <section id="signature1" style="margin-top: 20px; height: 150px;">
                ...
                <div style="width: 50%; height: 150px; text-align: center; float: left;">
                    <p>
                        ...
                        Pour l’inspecteur d’académie, directeur académiquedes services de l’éducation nationale de la
                        Loire <br>
                        Par délégation <br>
