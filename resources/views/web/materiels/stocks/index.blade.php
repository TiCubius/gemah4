						...
						<table class="table table-hover text-center">
							...
							<tbody>
								@foreach($searchedMateriels as $materiel)
									<tr>
										<td class="couleur" data-toggle="tooltip" data-placement="bottom" title="{{ $materiel->etat_administratif->libelle }}" style="width: 57px; background:{{ $materiel->etat->couleur }}"></td>
							...
							<ul class="list-group list-group-flush">
								@foreach($latestCreatedMateriels as $materiel)
									<li class="list-group-item d-flex justify-content-between">
										<div class="couleur" style="width: 31px; background:{{ $materiel->etat_administratif->couleur }}"></div>
