    ...
    @foreach($eleve->responsables as $responsable)
        ...
        <header>
            ...
            <section id="responsable" style="margin-top: 50px; margin-left: 58%;">
                <p>
                    L’Inspecteur d’académie, directeur académique <br> des services de l’éducation nationale de la Loire
                    <br> <br> à <br><br>
        ...
        <section id="content">
            <section id="lois" style="text-align: justify;">
                <p>
                    <i> Vu la circulaire n° 2001-061 du 5 avril 2001 publiée au Bulletin Officiel n° 15 du 12 avril
                        ...
                        des précision ssur les conventions de mise à disposition de ces matériels. </i>
                </p>
            </section>

            <section id="parties">
                <p>
                    Entre les soussignés : <br><br> D'une part le directeur académique des services de l’éducation
                    nationale de la Loire <br><br> Et, d'autre part : {{"{$responsable->nom} {$responsable->prenom}"}}
                    <br><br> Représentant légal de l'élève (articles L 131-4 du Code de l'Education) </p>
            ...
            <section id="article-1" style="margin-top: 50px; text-align: justify;">
                ...
                <p>
                    ...
                    droits et de l’autonomie est garante de l'attribution d'équipement répondant aux besoins
                    particuliers d'enfants déficients sensoriels et moteurs, après avis médical et pédagogique des
            ...
            <section id="article2" style="text-align: justify;">
                ...
                <p>
                    Pour <b>l'année scolaire {{ $parametres["conventions/annee"] }}</b> est mis à disposition le
                    matériel suivant appartenant à l’Etat : </p>
            ...
            <section id="article3" style="text-align: justify;">
                ...
                <p>Il ne sera demandé aucune contribution financière au bénéficiaire à l'exclusion des consommables
                    indispensables au fonctionnement du matériel. </p>
            </section>
            ...
            <section id="article4" style="text-align: justify;">
                ...
                <p>Le bénéficiaire s'engage à utiliser le bien qui lui est confié uniquement dans le cadre du travail
                    ...
                    à la présente convention (retrait ou adjonction). </p>
            </section>
            ...
            <section id="article5" style="text-align: justify;">
                ...
                <p>
                    ...
                    de la convention, ce matériel ne pourra être laissé à disposition de l’élève. <br><br> L'élève peut
                    conserver le bénéfice de cette opération <b>le temps de sa scolarité dans un établissement Education
                        Nationale de l'Académie de LYON</b> (premier et second degrés) ; s'il quitte cette dernière, le
                    matériel sera restitué à la direction des services départementaux de l’éducation nationale de la
                    Loire, qui assurera le lien avec l'Académie d'accueil.

                    @if($decision->date_limite)
                        Le prêt de matériel prendra fin le {{ $decision->date_limite->format("d/m/Y") }} en vertu de la
                        décision
                        du {{ $decision->date_notification ? $decision->date_notification->format("d/m/Y") : \Carbon\Carbon::now()->format("d/m/Y") }}
                        .
                    @endif
                </p>
            </section>
            ...
            <section id="signature1" style="margin-top: 20px; height: 150px;">
                ...
                <div style="width: 50%; height: 150px; text-align: center; float: left;">
                    <p>
                        ...
                        Loire <br> Par délégation <br><br> Le secrétaire général <br>
