                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item"
                           href="{{ route("web.scolarites.eleves.affectations.etablissements.index", [$eleve]) }}">Affecter
                            un établissement</a>
                        <a class="dropdown-item"
                           href="{{ route("web.scolarites.eleves.affectations.materiels.index", [$eleve]) }}">Affecter
                            un matériel</a>
                        <a class="dropdown-item"
                           href="{{ route("web.scolarites.eleves.affectations.responsables.index", [$eleve]) }}">Affecter
                            à un responsable</a>

                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ route('web.scolarites.eleves.edit', [$eleve]) }}">Modifier
                            l'élève</a>

                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item"
                           href="{{ route("web.scolarites.eleves.impressions.autorisations", [$eleve]) }}">Autorisation
                            CNIL</a>
                        <a class="dropdown-item"
                           href="{{ route("web.scolarites.eleves.impressions.consignes", [$eleve]) }}">Consignes du
                            matériel</a>
                        <a class="dropdown-item"
                           href="{{ route("web.scolarites.eleves.impressions.conventions", [$eleve]) }}">Convention</a>
                        <a class="dropdown-item"
                           href="{{ route("web.scolarites.eleves.impressions.recapitulatifs", [$eleve]) }}">Récapitulatif</a>
                        <a class="dropdown-item"
                           href="{{ route("web.scolarites.eleves.impressions.recuperations", [$eleve]) }}">Récépissé de
                            récupération</a>
                ...
                <div class="card w-100">
                    <div class="card-header gemah-bg-primary d-flex align-items-center justify-content-between">
                        ...
                        <button class="btn btn-sm btn-outline-warning" data-toggle="modal"
                                data-target="#modal-etablissements-{{ $eleve->etablissement->id }}">Désaffecter
                        </button>
                    </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="card w-100">
                    <div class="card-header gemah-bg-primary d-flex align-items-center justify-content-between">
                        ...
                        <button class="btn btn-sm btn-outline-warning" data-toggle="modal"
                                data-target="#modal-responsable-{{ $responsable->id }}">Désaffecter
                        </button>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <button class="btn btn-sm btn-outline-warning" data-toggle="modal"
                                                    data-target="#modal-materiel-{{ $materiel->id }}">Désaffecter
                                            </button>
                                        </div>
                                    </td>
                                </tr>
