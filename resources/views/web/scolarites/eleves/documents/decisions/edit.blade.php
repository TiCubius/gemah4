...
@section('content')
    ...
    <form action="{{ route('web.scolarites.eleves.documents.decisions.update', [$eleve, $decision]) }}" method="POST"
        ...
        <div class="col-6">
            <div class="js-mdph">
                <div class="form-group">
                    ...
                    <input type="date" id="date_cda" name="date_cda" placeholder="Date de la CDA" class="form-control"
                           value="{{ $decision->date_cda->format('Y-m-d') ?? '' }}">
                </div>
            </div>
            ...
            <div class="js-mdph">
                <div class="form-group">
                    ...
                    <input type="date" id="date_notif" name="date_notif"
                           ...
                           value="{{ $decision->date_notif->format('Y-m-d') ?? '' }}">
                </div>
            </div>
            ...
            <div class="js-mdph">
                <div class="form-group">
                    ...
                    <input type="date" id="date_limite" name="date_limite" placeholder="Date limite de la décision"
                           class="form-control" value="{{ $decision->date_limite->format('Y-m-d') ?? '' }}">
                </div>
            </div>
            ...
            <div class="js-mdph">
                <div class="form-group">
                    ...
                    <input type="date" id="date_lidate_conventionmite" name="date_convention"
                           ...
                           value="{{ $decision->date_convention->format('Y-m-d') ?? '' }}">
                </div>
            </div>
        </div>
        ...
        <div class="col-6">
            <div class="js-mdph">
                <div class="form-group">
                    ...
                    <input type="text" id="numero_dossier" name="numero_dossier" placeholder="Numéro du dossier Mdph"
        ...
        <div class="d-flex justify-content-between">
            <button class="btn btn-sm btn-outline-danger" type="button" data-toggle="modal" data-target="#modal">Supprimer la décision</button>
