            ...
            <form class="mb-3" action="{{ route("web.responsables.update", [$responsable]) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input id="email" class="form-control" name="email" type="email"
                           placeholder="Ex: john.smith@exemple.fr" value="{{ $responsable->email }}">
                </div>

                <div class="form-group">
                    <label class="optional" for="telephone">Téléphone</label>
                    <input id="telephone" class="form-control" name="telephone" type="text"
                           placeholder="Ex: 04 77 81 41 00" value="{{ $responsable->telephone }}">
                </div>


                <div class="form-group">
                    <label class="optional" for="code_postal">Code postal</label>
                    <input id="code_postal" class="form-control" name="code_postal" type="text" placeholder="Ex: 42100"
                           value="{{ $responsable->code_postal }}">
                </div>
