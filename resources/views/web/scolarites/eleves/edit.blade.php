        ...
        <div class="col-12">
            <form class="mb-3" action="{{ route("web.scolarites.eleves.update",[$eleve]) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input id="nom" class="form-control" name="nom" type="text" placeholder="Ex : Doe"
                ...
                <div class="form-group">
                    ...
                    <input id="date_naissance" class="form-control" name="date_naissance" type="date"
                           value="{{ $eleve->date_naissance->format("Y-m-d") }}" required>
                </div>

                <div class="form-group">
                    <label for="classe">Classe</label>
                    <input id="classe" class="form-control" name="classe" type="text" placeholder="Ex : 1e"
                ...
                <div class="form-group">
                    ...
                    <input id="code_ine" class="form-control" name="code_ine" type="text" value="{{ $eleve->code_INE }}"
                ...
                @foreach($types as $type)
                    <div class="custom-control custom-checkbox">
                        @if($eleve->types->contains($type))
                            <input checked id="type-{{ $type->id }}" class="custom-control-input" name="types[]"
                ...
                <div class="d-flex justify-content-between">
                    <button class="btn btn-sm btn-outline-danger" type="button" data-toggle="modal"
                            data-target="#modal">Supprimer l'élève
                    </button>
