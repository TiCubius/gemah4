...
class MaterielController extends Controller
{
	...
	public function index(Eleve $eleve, Request $request): View
	{
		...
		if ($request->hasAny(["type_materiel_id", "etat_administratif_materiel_id", "etat_physique_materiel_id", "marque", "modele", "numero_serie", "cle_produit", "achat_pour"])) {
			$materiels = Materiel::search($request->input("departement_id"), $request->input("type_materiel_id"), $request->input("etat_administratif_materiel_id"), $request->input("etat_physique_materiel_id"), $request->input("marque"), $request->input("modele"), $request->input("numero_serie"), $request->input("cle_produit"), $request->input("achat_pour"))->where("eleve_id", null)->with("eleve", "etatAdministratif", "etatPhysique", "type", "type.domaine")->get();
		}
