    ...
    <div class="row">
            ...
            @slot("custom")
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                        ...
                        <a class="dropdown-item" href="{{ route("web.scolarites.eleves.affectations.etablissements.index", [$eleve]) }}">Affecter
                            un établissement</a> @endHas @hasPermission("affectations/materiels/index")
                        <a class="dropdown-item" href="{{ route("web.scolarites.eleves.affectations.materiels.index", [$eleve]) }}">Affecter
                            @endHas @hasPermission("affectations/responsables/index")
                            <a class="dropdown-item" href="{{ route("web.scolarites.eleves.affectations.responsables.index", [$eleve]) }}">Affecter
                                à un responsable</a> @endHas

                            @hasPermission("eleves/edit")
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{ route('web.scolarites.eleves.edit', [$eleve]) }}">Éditer
                                l'élève</a> @endHas

                            <div class="dropdown-divider"></div>
                            @hasPermission("eleves/impressions/autorisations")
                            <a class="dropdown-item" href="{{ route("web.scolarites.eleves.impressions.autorisations", [$eleve]) }}" target="_blank">Autorisation
                                CNIL</a> @endHas @hasPermission("eleves/impressions/consignes")
                            <a class="dropdown-item" href="{{ route("web.scolarites.eleves.impressions.consignes", [$eleve]) }}" target="_blank">Consignes
                                du matériel</a> @endHas @hasPermission("eleves/impressions/conventions")
                            ...
                            <a class="dropdown-item" href="{{ route("web.scolarites.eleves.impressions.recuperations", [$eleve]) }}" target="_blank">Récépissé
                                de récupération</a> @endHas
                    </div>
                </div>
            @endslot
        @endcomponent
        ...
        <div class="col-md-6 mb-3">
            <div class="card w-100">
                ...
                <div class="card-body">
                    <strong>Nom</strong>: {{ $eleve->nom }} <br> <strong>Prénom</strong>: {{ $eleve->prenom }} <br>
                    ...
                    <div class="card-footer">
                        <div class="dropup">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                                ...
                                <a class="dropdown-item" href="{{ route("web.scolarites.etablissements.show", [$eleve->etablissement]) }}" target="_blank">Détails
                                    de l'établissement</a> @endHas @hasPermission("responsables/edit")
                                <a class="dropdown-item" href="{{ route("web.scolarites.etablissements.edit", [$eleve->etablissement]) }}" target="_blank">Éditer
                                    l'établissement</a> @endHas

                                <div class="dropdown-divider"></div>
                                @hasPermission("affectations/responsables/detach")
                                <div class="dropdown-item">
                                    <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modal-etablissements-{{ $eleve->etablissement->id }}">
                                        Désaffecter l'établissement
                                    </button>
                                </div>
                                @endHas
                            </div>
                ...
                <div class="card w-100">
                    <div class="card-header gemah-bg-primary d-flex align-items-center justify-content-between">
                        ...
                        @if($responsable->pivot->etat_signature)
                            <div class="badge badge-success m-0">A signé</div>
                        @else
                            <div class="badge badge-danger m-0">N'a pas signé</div>
                        @endif
                    </div>
                    <div class="card-body">
                        ...
                        <div class="dropup">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                                ...
                                <a class="dropdown-item" href="{{ route("web.responsables.show", [$responsable]) }}" target="_blank">
                                    Détails du responsable </a> @endHas @hasPermission("responsables/edit")
                                <a class="dropdown-item" href="{{ route("web.responsables.edit", [$responsable]) }}" target="_blank">
                                    Éditer le responsable </a> @endHas

                                <div class="dropdown-divider"></div>
                                @hasPermission("affectations/responsables/detach")
                                <div class="dropdown-item">
                                    <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modal-responsable-{{ $responsable->id }}">
